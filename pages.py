...
def get_public_page_html(uuid_key: str) -> str:
    """Compatibility wrapper for the production subscription profile page."""
    from subscription_page import get_public_page_html as _get_public_page_html
    return _get_public_page_html(uuid_key)
